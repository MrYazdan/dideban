// Package logger provides structured logging functionality for the Dideban monitoring system.
//
// This package uses zerolog to provide a consistent logging interface
// throughout the application with proper structured logging capabilities.
//
// Example usage:
//
//	logger.Init(cfg)
